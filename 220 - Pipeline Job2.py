...
ws = Workspace.from_config("./Documents/Data Scients Certificate/DP-100 A-Z Machine Learning using Azure Machine Learning/setup-azureml-workspace/config")
...
dataPrep_step = PythonScriptStep(name='01 Data Preparation',
                                 source_directory='./Documents/Data Scients Certificate/DP-100 A-Z Machine Learning using Azure Machine Learning/setup-azureml-workspace',
