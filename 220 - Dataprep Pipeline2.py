...
num_cols = dataPrep.select_dtypes(include=np.number).columns
...
for column in num_cols:
    dataPrep[column] = pd.to_numeric(dataPrep[column], errors='coerce')
 
# Drop rows with NaN values that could not be converted to numeric
